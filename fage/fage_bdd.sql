...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 28 déc. 2025 à 14:37
...
INSERT INTO `benevole` (`id_benevole`, `nom`, `prenom`, `email`, `mot_de_passe`, `role`, `date_creation`) VALUES
(1, 'Admin', 'Principal', 'admin@fage.org', 'admin', 'admin', '2025-12-26 11:29:56');
