...
<head>
    ...
    <title>FAGE | Fédération des Associations Générales Étudiantes</title>
...
<main>
    ...
    <section class="hero-section">
        <img src="https://f.hellowork.com/edito/sites/5/2024/01/FAGE-visuels-768x432.jpeg" alt="FAGE Étudiants" class="hero-bg-img">
    ...
    <section id="actions" class="container grid-3">
        <article class="card reveal">
            ...
            <h3>S'informer</h3>
            <p>Parcoursup, Master, bourses, logements et santé : la FAGE accompagne les étudiant·e·s toute l'année.</p>
        </article>
        <article class="card reveal">
            <div class="card-icon">🤝</div>
            <h3>S'entraider</h3>
            <p>Réseau d'AGORAé (épiceries solidaires), Kiosque solidaire, et actions de lutte contre la précarité.</p>
        </article>
        <article class="card reveal">
            <div class="card-icon">📢</div>
            <h3>Agir</h3>
    ...
    <section class="container" style="background-color: #f9fafb; padding: 40px; border-radius: 10px; margin-bottom: 40px;">
        <h2 style="font-size: 2rem; font-weight: bold; margin-bottom: 2rem; text-align:center;">La FAGE en chiffres</h2>
    ...
    <section class="container" style="margin-top: 60px; margin-bottom: 60px; text-align: center;">
        ...
        <div class="reveal" style="width: 100%; max-width: 1000px; margin: 0 auto; border-radius: 15px; overflow: hidden; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
            <iframe
                    width="100%"
                    height="450"
                    frameborder="0"
